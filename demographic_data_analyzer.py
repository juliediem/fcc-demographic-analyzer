...
def calculate_demographic_data(print_data=True):
    ...
    # percentage_bachelors = ((df[df['education']=='Bachelors'].size/df.size)*100).round(2)
    percentage_bachelors=percentage(df[df['education']=='Bachelors'],df)
    ...
    # higher_education_rich = ((df[df['education'].isin(['Bachelors','Masters','Doctorate'])&(df['salary']=='>50K')].size/df.size)*100).round(2)
    higher_education_rich = percentage(df[df['education'].isin(['Bachelors','Masters','Doctorate'])&(df['salary']=='>50K')],df)
    lower_education_rich = percentage(df[~df['education'].isin(['Bachelors','Masters','Doctorate'])&(df['salary']=='>50K')],df)
